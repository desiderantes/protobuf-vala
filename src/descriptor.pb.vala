// Generated by protoc-gen-vala 0.1.0 from descriptor.proto, do not edit
...
public class FileDescriptorSet : Protobuf.Message
{
    ...
    {
        this.file = new List<FileDescriptorProto> ();
    }
...
public class FileDescriptorProto : Protobuf.Message
{
    ...
    public FileDescriptorProto ()
    {
        ...
        this.message_type = new List<DescriptorProto> ();
        this.enum_type = new List<EnumDescriptorProto> ();
        this.service = new List<ServiceDescriptorProto> ();
        this.extension = new List<FieldDescriptorProto> ();
        this.options = null;
...
public class DescriptorProto : Protobuf.Message
{
    ...
    {
        this.name = "";
        this.field = new List<FieldDescriptorProto> ();
        this.extension = new List<FieldDescriptorProto> ();
        this.nested_type = new List<DescriptorProto> ();
        this.enum_type = new List<EnumDescriptorProto> ();
        this.extension_range = new List<ExtensionRange> ();
        this.options = null;
    }
...
public class EnumDescriptorProto : Protobuf.Message
{
    ...
    {
        this.name = "";
        this.value = new List<EnumValueDescriptorProto> ();
        this.options = null;
    }
...
public class ServiceDescriptorProto : Protobuf.Message
{
    ...
    {
        this.name = "";
        this.method = new List<MethodDescriptorProto> ();
        this.options = null;
    }
...
public class FileOptions : Protobuf.Message
{
    ...
    public override string to_string (string indent = "")
    {
        ...
        text += indent + "go_package: %s\n".printf (Protobuf.string_to_string (this.go_package));
...
public class SourceCodeInfo : Protobuf.Message
{
    public class Location : Protobuf.Message
    {
        ...
        public override string to_string (string indent = "")
        {
            ...
            text += indent + "leading_comments: %s\n".printf (Protobuf.string_to_string (this.leading_comments));
            text += indent + "trailing_comments: %s\n".printf (Protobuf.string_to_string (this.trailing_comments));
